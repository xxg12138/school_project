<template>
  <div class="dashboard-container">
    ...
    <el-card class="header-card">
      <div>
        <div class="fl headL">
          <div class="headImg">
            <img
              v-imgeerror="defaultImg"
              :src="getffPhoto"
            >
          </div>
          <div class="headInfoTip">
            <p class="firstChild">早安，{{ name }}，祝你开心每一天！</p>
            <p class="lastChild">{{ name }} | {{ $store.state.user.userInfo.companyName }} - {{ userInfo.departmentName }}</p>
          </div>
        </div>
        <div class="fr" />
      </div>
              ...
              <ul class="noticeList">
                <li>
                  <div class="item">
                    ...
                    <div>
                      <p><span class="col">小小怪</span> 发布了 第1期“校园大讲堂”互动讨论获奖名单公布</p>
                ...
                <li>
                  <div class="item">
                    <img src="@/assets/common/img.jpeg" alt="">
                    <div>
                      <p><span class="col">大大怪</span> 发布了 第2期“校园大讲堂”互动讨论获奖名单公布</p>
                      <p>2018-07-21 15:21:38</p>
                    </div>
                  </div>
                </li>
                <li>
                  <div class="item">
                    <img src="@/assets/common/img.jpeg" alt="">
                    <div>
                      <p><span class="col">宅博士</span> 发布了 第3期“校园大讲堂”互动讨论获奖名单公布</p>
                      <p>2018-07-21 15:21:38</p>
                    </div>
                  </div>
                </li>
    ...
    <el-dialog :visible.sync="showDialog" title="离职申请">
      <el-form ref="ruleForm" :rules="rules" :model="ruleForm" label-width="110px">
        <el-form-item prop="exceptTime" label="加班开始时间">
          <el-date-picker
...
import work_calendar from './components/work-calendar.vue'
